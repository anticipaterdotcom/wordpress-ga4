...
define('ANTICIPATER_GA4_VERSION', '1.0.1');
...
class Anticipater_GA4_Events {
    ...
    public function render_import_export_page() {
        ...
        jQuery(function($) {
            ...
            $('#load-defaults').on('click', function() {
                var defaults = <?php 
                    $json_file = plugin_dir_path(__FILE__) . 'imports/purezza-events.json';
    ...
    public function ajax_log_event() {
        ...
        $wpdb->insert($table_name, [
            ...
            'event_data' => is_string($_POST['event_data'] ?? '') ? $_POST['event_data'] : wp_json_encode($_POST['event_data'] ?? []),
